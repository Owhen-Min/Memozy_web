...
public class HistoryController {
	...
	@GetMapping("/streaks")
	public ApiResponse<LearningContributionResponse> getHistory(
		@Parameter(hidden = true) @AuthenticationPrincipal CustomOAuth2User customOAuth2User) {
		LearningContributionResponse history = historyService.getUserStreaks(customOAuth2User.getUserId(),
